...
<div class="w-100">
<form method="post" action="employeelogin" class="loginform">
		<div class="mt-3">
		 <h2>Login</h2>
		</div>
		<div class="form-group input1 col-10 center mt-5">
            ...
            <input id="inputaccount" type="text" style="text-align:center;" name="empAccount" class="form-control" value="pekora" autocomplete="off" required/>
        </div>
        <div class="form-group input2 col-10 center mt-3">
        	<label class="label2 text-muted" for="inputpassword" style=";">Password</label>
            <input id="inputpassword" type="password" style="text-align:center;" name="empPassword" class="form-control" value="hahahaha" autocomplete="off" required/>
        </div>
        <div class="mt-5">
