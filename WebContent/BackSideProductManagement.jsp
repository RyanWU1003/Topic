						...
						<tbody class="productlist">
							<c:forEach var="product1" items="${bsproductList }">
								<tr class="product" style="line-height:25px;" height="250px">
									...
									<input class="updatebutton" type="button" value="更新" onclick="location.href='toBsUpdateProduct?id=${product1.productID }'"></input>
									<input class="deletebutton" type="button" value="刪除" onclick="location.href='bsDelProduct?id=${product1.productID }'"></input>
									</td>
